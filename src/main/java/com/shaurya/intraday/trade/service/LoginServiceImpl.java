...
public class LoginServiceImpl implements LoginService {
	...
	@Override
	public void initializeSdkClient(String requestToken) throws JSONException, IOException, KiteException {
		// Get accessToken as follows,
		User userModel = kiteSdk.generateSession(requestToken, accountService.getAccount().getSecretKey());
